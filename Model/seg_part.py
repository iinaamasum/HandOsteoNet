    ...
    def __init__(self, input_size=480):
        ...
        self.decoder = nn.ModuleList(
            [
                nn.Sequential(
                    nn.ConvTranspose2d(
                        440, 208, kernel_size=4, stride=2, padding=1, bias=False
                    ),
                    nn.BatchNorm2d(208),
                ...
                nn.Sequential(
                    nn.ConvTranspose2d(
                        416, 104, kernel_size=4, stride=2, padding=1, bias=False
                    ),
                    nn.BatchNorm2d(104),
                    nn.ReLU(inplace=True),
                ),
                nn.Sequential(
                    nn.ConvTranspose2d(
                        208, 48, kernel_size=4, stride=2, padding=1, bias=False
                    ),
                    nn.BatchNorm2d(48),
                    nn.ReLU(inplace=True),
                ),
                nn.Sequential(
                    nn.ConvTranspose2d(
                        96, 32, kernel_size=4, stride=2, padding=1, bias=False
                    ),
                    nn.BatchNorm2d(32),
                    nn.ReLU(inplace=True),
                ),
                nn.Sequential(
                    nn.ConvTranspose2d(
                        32, 1, kernel_size=4, stride=2, padding=1, bias=False
                    ),
                    nn.BatchNorm2d(1),
                    nn.ReLU(inplace=True),
